...
def get_idp_user_mgmt_object(idp_name):
    ...
    if (idp_name.upper() == 'COGNITO'):
        ...
        idp_user_mgmt_impl_class = getattr(importlib.import_module("authzero.auth0_idp_user_management_service"), "Auth0IdpUserManagementService")
...
def get_idp_mgmt_object(idp_name):
    ...
    if (idp_name.upper() == 'COGNITO'):
        ...
        idp_impl_class = getattr(importlib.import_module("authzero.auth0_identity_provider_management"), "Auth0IdentityProviderManagement")
...
def get_idp_authorizer_object(idp_name):
    ...
    if (idp_name.upper() == 'COGNITO'):
        ...
        idp_authorizer_impl_class = getattr(importlib.import_module("authzero.auth0_idp_authorizer"), "Auth0IdpAuthorizer")
